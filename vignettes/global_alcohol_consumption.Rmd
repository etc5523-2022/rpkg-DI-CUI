...
This vignette shows how to use asdata pacakge to give a good overview of national alcohol consumption and the servings of beer, spiritr and wine, and to make it easy to compare alcohol consumption and servings from country to country, as well as to see the global development of alcohol.
...
# Data.frame about alcohol consumption and servings

You could produce data.frame about alcohol consumption and servings by using `extract_country_servings()` function and `calculate_country_alcohol()` function.
...
This function has $2$ argument: `range` (The range of alcohol servings) and  `type`(the type of alcohol servings, one of "beer_servings", "spirit_servings" and "wine_servings").
...
This function has $2$ argument: `name` and  `type`(he type of alcohol value, one of "beer_servings", "spirit_servings", "wine_servings" and "total_litres_of_pure_alcohol").
